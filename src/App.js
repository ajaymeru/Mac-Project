...
import ActivitySummaryUser from "./pages/activities/manageactivities/ActivitySummaryUser";
import ActivityScreenEndUser from "./pages/activities/manageactivities/ActivityScreenEndUser";
import ActivityVendorUser from "./pages/activities/manageactivities/ActivityVendorUser";
    ...
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/app" element={<Layout />}>
          ...
          <Route path="/app/activity-summary-user" element={<ActivitySummaryUser />} />
          <Route path="/app/activity-screen-enduser" element={<ActivityScreenEndUser />} />
          <Route path="/app/activity-vendor-user" element={<ActivityVendorUser />} />
