...
function ApproveVendor() {
    ...
    const [empObj, setEmpObj] = React.useState({
        id: 1, account_code: 'ac_1', organization_name: 'Reliance', phone: '7685563323', email:'balajikr@gmail.com', person_name: 'Balaji', gst: 'ADG885675', pan: 'ERP7844963', client_id: ['Client 1'], address: 'Hyderabad'
    })
    ...
    return (
        <div className='employeeContainer'>
            <h5 className='create-employee'>Approve Vendor</h5>
            <div className="card forms-card">
                ...
                <div className="text-center">
                  ...
                  <button className='btn btn-dark px-4' onClick={() => {navigate('/admin/manage-vendors')}}>Cancel</button>
                </div>
            </div>
        </div>
    )
