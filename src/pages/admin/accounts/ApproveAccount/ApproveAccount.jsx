...
import "../CreateAccount/create-account.css"
...
function ApproveAccount() {
    ...
    const [empObj, setEmpObj] = React.useState({
        id: 1, account_code: 'ac_1', organization_name: 'Reliance', phone: '7685563323', email:'balajikr@gmail.com', person_name: 'Balaji', gst: 'ADG885675', pan: 'ERP7844963',  address: 'Hyderabad'
    })
    ...
    return (
        <div className='employeeContainer'>
            <h5 className='create-employee'>Approve Client</h5>
            <div className="card forms-card">
                ...
                <div className="text-center">
                  <button className='btn btn-success px-4 me-4' onClick={() => {}}>Approve</button>
                  <button className='btn btn-danger px-4 me-4' onClick={() => {}}>Reject</button>
                  <button className='btn btn-dark px-4' onClick={() => {navigate('/admin/manage-clients')}}>Cancel</button>
                </div>
            </div>
        </div>
    )
