...
function ViewActivity() {
    ...
    return (
        <div className='employeeContainer'>
            <h5 className='create-employee'>View Activity</h5>
            <div className="card forms-card">
                <div className="row mb-3">
                    <div className="col-12 mb-3">
                        <TextField className='w-100' disabled id="outlined-basic" variant="standard" label="Title" autoComplete="off" required 
                            value={formObj.title}
                            onChange={(ev) => {
                    ...
                    <div className="col-12 mb-3">
                        <FormControl fullWidth disabled variant="standard" required>
                    ...
                    <div className="col-12 mb-3">
                        <TextField className='w-100' disabled multiline rows="3" id="outlined-basic" variant="standard" label="Description" autoComplete="off" 
                          ...
                          <div className="col-12">
                            ...
                            <div className="d-flex">
                              ...
                              <div className="mb-3 d-flex align-items-end">
                                  <TextField disabled className='w-100' id="outlined-basic" variant="standard" value="Reference Image" label="" />
                              ...
                              <div className="mb-3 d-flex align-items-end">
                                  <TextField disabled className='w-100' id="outlined-basic" variant="standard" value="Execution Image" label="" />
                                  <button className="btn btn-light text-primary px-4 me-2" onClick={() => {
                                    setOpenExec(true);
                                    setExecImg(task.execution_image)
                                  }}><IoMdEye /></button>
                ...
                <div className="text-center">
                  <button className='btn btn-primary px-4 me-4 rounded-pill' style={{minWidth: 160}} onClick={() => {setOpenStatus(true)}}>Change Status</button>
                  <button className='btn btn-success px-4 me-4 rounded-pill' style={{minWidth: 160}} onClick={() => {}}>Approve</button>
                  <button className='btn btn-danger px-4 rounded-pill' style={{minWidth: 160}} onClick={() => {}}>Reject</button>
                </div>
            </div>
