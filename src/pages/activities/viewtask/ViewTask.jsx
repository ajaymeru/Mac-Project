        ...
        <div className='employeeContainer'>
            <div className="row">
              ...
              <div className="col-12 col-lg-6 text-end">
                <button className="btn btn-success px-4 py-1 me-3" onClick={() => {setOpenAssign(true)}}>Assign To</button>
                <button className="btn btn-danger px-4 py-1 me-3" onClick={() => {setOpenStatus(true)}}>Change Status</button>
              </div>
            </div>
